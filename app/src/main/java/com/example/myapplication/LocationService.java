...
public class LocationService extends Service {
    ...
    private ContentProviderService provService; // Δήλωση του ProviderService
    public static volatile boolean service_on = true;
    ...
    public void onCreate() {
        ...
        provService = new ContentProviderService(resolver, this); // Αρχικοποίηση του ProviderService με το context
